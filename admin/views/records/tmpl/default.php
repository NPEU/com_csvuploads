    ...
    <table class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th width="40%">
                    <?php echo JHtml::_('grid.sort', 'COM_CSVUPLOADS_RECORDS_TITLE', 'title', $listDirn, $listOrder); ?>
                </th>
                <th width="40%">
                    <?php echo JHtml::_('grid.sort', 'COM_CSVUPLOADS_RECORDS_SLUG', 'slug', $listDirn, $listOrder); ?>
                </th>
                <th width="10%">
                    <?php echo JHtml::_('grid.sort', 'COM_CSVUPLOADS_PUBLISHED', 'published', $listDirn, $listOrder); ?>
                </th>
                <th width="4%">
                    <?php echo JHtml::_('grid.sort', 'COM_CSVUPLOADS_ID', 'id', $listDirn, $listOrder); ?>
                </th>
            </tr>
        </thead>
        <tfoot>
