 ...
 */
class CSVUploadsModelRecord extends JModelAdmin
{
    /**
    ...
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState(
            'com_csvuploads.edit.records.data',
            array()
        );
    ...
    private function _sendEmail($email_data)
    {
            ...
            $mail->setSubject(JText::_('COM_CSVUPLOADS_EMAIL_ADMINS_SUBJECT'));
            $mail->setBody(JText::_('COM_CSVUPLOADS_EMAIL_ADMINS_BODY'));
            $sent = $mail->Send();
